    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {([
              { key: 'submissions' as const, label: 'Assignment submissions', desc: 'When students submit work' },
              { key: 'quizzes' as const, label: 'Quiz results', desc: 'When students complete quizzes' },
              { key: 'announcements' as const, label: 'Announcements', desc: 'Platform and course updates' },
              { key: 'messages' as const, label: 'Messages', desc: 'New student messages' },
              { key: 'emailDigest' as const, label: 'Weekly email digest', desc: 'Summary of your teaching week' },
            ]).map((item) => (
