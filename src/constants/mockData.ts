...
export const mockUsers: Record<string, User> = {
  ...
  teacher: {
    ...
    role: 'teacher',
    avatar: 'https://i.pinimg.com/474x/fc/f0/63/fcf063d97be8e001f12409bd74615525.jpg',
...
export const mockAssignments: Assignment[] = [
  ...
  },
  {
    ...
    submissionCount: 1,
    submissionFileUrl: '/files/wave-motion-lab-report.pdf',
  ...
  },
  {
    ...
    submissionCount: 1,
    submissionFileUrl: '/files/modern-poetry-analysis.pdf',
...
export const mockNotifications: Notification[] = [
  { id: '1', title: 'Assignment Due Tomorrow', message: 'Calculus Problem Set #5 is due tomorrow at 11:59 PM.', type: 'assignment', read: false, createdAt: '2026-06-25T08:00:00' },
  { id: '2', title: 'New Quiz Available', message: 'Integration Techniques quiz is now available.', type: 'quiz', read: false, createdAt: '2026-06-25T07:30:00' },
  { id: '3', title: 'Fee Payment Reminder', message: 'Your semester fee payment is due in 5 days.', type: 'payment', read: false, createdAt: '2026-06-24T14:00:00' },
  { id: '4', title: 'Class Announcement', message: 'Physics lab session moved to Room 204.', type: 'announcement', read: true, createdAt: '2026-06-24T10:00:00' },
  { id: '5', title: 'Grade Posted', message: 'Your grade for Essay: Modern Poetry Analysis has been posted.', type: 'assignment', read: true, createdAt: '2026-06-23T16:00:00' },
]
